...
//calculating factorial for very big numbers
...
//first ateemp to solve it more efficiently, 

//phase - string, comes "!" either "!!",  where "!" stand for usual factorial, and "!!"
//stand for factorial through one like "10!! === 2 * 4 * 6 * 8 * 10`"
function zerosInFactorial(number, phase){   
    var zeros = 0;
    if(phase == "!"){
        zeros += Math.floor(number / 5)     
        zeros += Math.floor(number / 25);  
